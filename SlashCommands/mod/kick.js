    ...
    run: async(client, interaction, args) => {
        ...
        try{
            await mentionedMember.kick(reason).then(() => {
                interaction.editReply({ content: `:white_check_mark: @${mentionedMember.user.username} has been kicked from the server ` }) //send a message in channel that you banned that user
            })
