    ...
    run: async(client, interaction, args) => {
        ...
        try{
            ...
            await mentionedMember.ban({ reason: reason }).then(() => { //then ban the user
                interaction.editReply({ content: `:airplane: ${mentionedMember.user.username} has been banned from the server ` }) //send a message in channel that you banned that user
            })
